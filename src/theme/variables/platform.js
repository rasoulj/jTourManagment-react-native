...
export default {
    dfont: "byekan", //iranyekanwebregular
    darrow: "ios-arrow-dropleft",
    ...
    // Button
    btnFontFamily: platform !== "ios" ? "System" : this.dfont,
    ...
    // Font
    fontFamily: platform !== "ios" ? "System" : this.dfont,
    fontSizeBase: 15,
    get fontSizeH1() {
    ...
    // Title
    titleFontfamily: platform === "ios" ? "System" : this.dfont,
